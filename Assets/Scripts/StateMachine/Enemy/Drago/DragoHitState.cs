...
public class DragoHitState : EnemyBaseState
{
    ...
    public DragoHitState(EnemyController controller) : base(controller) { }
    ...
    public override void EnterState(EnemyStateManager enemy)
    {
        ...
        EnemySoundHolder.Instance.PlayAudio(EnemySoundHolder.Instance.EnemySFXDictionary["Drago"].Clips["Hit"], false);
