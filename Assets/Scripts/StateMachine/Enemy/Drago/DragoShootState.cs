...
public class DragoShootState : EnemyBaseState
{
    ...
    public DragoShootState(EnemyController controller) : base(controller) { }
    ...
    {
        SetRotation();
        EnemySoundHolder.Instance.PlayAudio(EnemySoundHolder.Instance.EnemySFXDictionary["Drago"].Clips["Shoot"] ,false);
